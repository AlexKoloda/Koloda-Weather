...
const searchInput = document.querySelector(".weather-input-location");
...
function displayResult(weather) {
  let city = document.querySelector(".weather-container-location");
  ...
  minMaxTemperature.innerText = `min: ${Math.round(
...
const temperatureClick = document.querySelector(
